...
exports.default = {
  slideshowRequiresTitle: "Every slideshow needs a title. Enter the title after the command - \"/tektocs-startlive titleOfYourSlideshow\"",
  ...
  noData: "No Data",
  couldNotFindRecordForTeam: function couldNotFindRecordForTeam() {
    return "Could not find a record for team_id:" + (arguments.length <= 0 ? undefined : arguments[0]);
  },
  errorGettingSlideData: "Error getting slide data."
};